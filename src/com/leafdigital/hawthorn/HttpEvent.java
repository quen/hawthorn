...
public class HttpEvent extends Event
{
	...
	private void handleLeave(HashMap<String,String> params) throws OperationException
	{
		...
		Message m=new LeaveMessage(System.currentTimeMillis(),channel,
			connection.toString(),params.get("user"),params.get("displayname"),false);
		getApp().getOtherServers().sendMessage(m);
		c.message(m,false);
